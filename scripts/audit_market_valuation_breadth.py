"""Independent integrity audit for market valuation breadth v1."""
...
RESULT = ROOT / "reports/market_valuation_breadth.json"
MANIFEST = ROOT / "data/processed/factors/market_valuation_fetched_dates.csv"
FEATURES = ROOT / "data/processed/factors/market_valuation_breadth.csv"
OUTPUT = ROOT / "reports/market_valuation_breadth_integrity.json"
...
def main():
    ...
    right = {
        record["date"]: bool(record["hit"])
        for record in result["variants"]["plus_market_valuation_breadth"]["records"]
    }
    common = set(left).intersection(right)
    increment = result["valuation_increment"]
