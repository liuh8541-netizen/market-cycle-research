"""Independent integrity audit for market-cap structure v1."""
...
RESULT = ROOT / "reports/market_cap_structure.json"
MANIFEST = ROOT / "data/processed/factors/market_cap_fetched_dates.csv"
FEATURES = ROOT / "data/processed/factors/market_cap_structure.csv"
OUTPUT = ROOT / "reports/market_cap_structure_integrity.json"
...
def main():
    ...
    right = {
        record["date"]: bool(record["hit"])
        for record in result["variants"]["plus_market_cap_structure"]["records"]
    }
    common = set(left).intersection(right)
    increment = result["market_cap_increment"]
